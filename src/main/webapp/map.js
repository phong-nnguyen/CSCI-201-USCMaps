document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleSearch() {
        ...
        if (query) {
            try {
                // Use hardcoded API key instead of fetching
                const apiKey = 'AIzaSyDGIPlUnED-AeiAjI7oZaQm6WDPzpSpMPg';
    ...
    try {
        ...
        ws.onerror = function(error) {
            ...
            // Don't treat this as a critical error - the map can still function
        };
    } catch (e) {
    ...
    // Make sure dropdowns are set up properly
    // First check if the function is available in the global scope
    
    // Manually set up the dropdowns as a fallback
